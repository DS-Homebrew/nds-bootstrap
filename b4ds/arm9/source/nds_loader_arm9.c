...
void runNds(loadCrt0* loader, u32 loaderSize, u32 cluster, u32 saveCluster, u32 donor2Cluster, u32 donorCluster, u32 apPatchCluster, u32 patchOffsetCacheCluster, u32 srParamsCluster, configuration* conf) {
