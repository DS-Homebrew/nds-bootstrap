...
cp bootstrap.nds bootstrap-dldi.nds

$DEVKITARM/bin/dlditool dldi/dsisd.dldi bootstrap-dldi.nds
$DEVKITARM/bin/dlditool dldi/dsisd.dldi bootstrap-nogba.nds

python patch_ndsheader_dsiware.py --mode dsi bootstrap.nds
python patch_ndsheader_dsiware.py --mode dsi bootstrap-dldi.nds
