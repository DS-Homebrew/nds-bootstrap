...
.word   readCachedRef
.word   arm7Functions
.word   jmpToJmpTo_newGetPitchTable
.word   jmpTo_newGetPitchTable
...
@---------------------------------------------------------------------------------
	...
	.thumb
@---------------------------------------------------------------------------------
jmpToJmpTo_newGetPitchTable:
@---------------------------------------------------------------------------------
	ldr r3, =jmpTo_newGetPitchTable
	bx r3
@---------------------------------------------------------------------------------
...
@---------------------------------------------------------------------------------
jmpTo_newGetPitchTable:
@---------------------------------------------------------------------------------
	ldr pc, = newGetPitchTable
@---------------------------------------------------------------------------------
