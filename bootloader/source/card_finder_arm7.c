...
const u32 swi12Signature[1] = {0x4770DF12}; // LZ77UnCompReadByCallbackWrite16bit

const u32 swiGetPitchTableSignature1[4]      = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x00004721};
const u32 swiGetPitchTableSignature1Alt1[4]  = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x00004BB9};
const u32 swiGetPitchTableSignature1Alt2[4]  = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x00004BC9};
const u32 swiGetPitchTableSignature1Alt3[4]  = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x00004BE5};
const u32 swiGetPitchTableSignature1Alt4[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803BE9};
const u32 swiGetPitchTableSignature1Alt5[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803E05};
const u32 swiGetPitchTableSignature1Alt6[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803E09};
const u32 swiGetPitchTableSignature1Alt7[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803F21};
const u32 swiGetPitchTableSignature1Alt8[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804189};
const u32 swiGetPitchTableSignature3[3]      = {0xE59FC000, 0xE12FFF1C, 0x03800FD5};
const u32 swiGetPitchTableSignature3Alt1[3]  = {0xE59FC000, 0xE12FFF1C, 0x03801149};
const u32 swiGetPitchTableSignature3Alt2[3]  = {0xE59FC000, 0xE12FFF1C, 0x03801215};
const u32 swiGetPitchTableSignature3Alt3[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804119};
const u32 swiGetPitchTableSignature3Alt4[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804301};
const u32 swiGetPitchTableSignature3Alt5[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804305};
const u32 swiGetPitchTableSignature3Alt6[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804395};
const u32 swiGetPitchTableSignature3Alt7[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804439};
const u32 swiGetPitchTableSignature3Alt8[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804559};
const u32 swiGetPitchTableSignature3Alt9[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804615};
const u32 swiGetPitchTableSignature3Alt10[3] = {0xE59FC000, 0xE12FFF1C, 0x038053E1};
const u32 swiGetPitchTableSignature4[3]      = {0xE59FC000, 0xE12FFF1C, 0x038006A1};
const u32 swiGetPitchTableSignature4Alt1[3]  = {0xE59FC000, 0xE12FFF1C, 0x03800919};
const u32 swiGetPitchTableSignature4Alt2[3]  = {0xE59FC000, 0xE12FFF1C, 0x03800925};
const u32 swiGetPitchTableSignature4Alt3[3]  = {0xE59FC000, 0xE12FFF1C, 0x038035C5};
const u32 swiGetPitchTableSignature4Alt4[3]  = {0xE59FC000, 0xE12FFF1C, 0x038035ED};
const u32 swiGetPitchTableSignature4Alt5[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803715};
const u32 swiGetPitchTableSignature4Alt6[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803829};
const u32 swiGetPitchTableSignature4Alt7[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803ED5};
const u32 swiGetPitchTableSignature4Alt8[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803F15};
const u32 swiGetPitchTableSignature5[4]      = {0x781A4B06, 0xD3030791, 0xD20106D1, 0x1A404904};

const u32 swiHaltSignature1[4]      = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x00007BAF};
const u32 swiHaltSignature1Alt1[4]  = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x0000B7A3};
const u32 swiHaltSignature1Alt2[4]  = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x0000B837};
const u32 swiHaltSignature1Alt3[4]  = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x0000B92B};
const u32 swiHaltSignature1Alt4[4]  = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x0000BAEB};
const u32 swiHaltSignature1Alt5[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803B93};
const u32 swiHaltSignature1Alt6[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803DAF};
const u32 swiHaltSignature1Alt7[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803DB3};
const u32 swiHaltSignature1Alt8[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803ECB};
const u32 swiHaltSignature1Alt9[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803F13};
const u32 swiHaltSignature1Alt10[3] = {0xE59FC000, 0xE12FFF1C, 0x03804133};
const u32 swiHaltSignature3[3]      = {0xE59FC000, 0xE12FFF1C, 0x03800F7F};
const u32 swiHaltSignature3Alt1[3]  = {0xE59FC000, 0xE12FFF1C, 0x038010F3};
const u32 swiHaltSignature3Alt2[3]  = {0xE59FC000, 0xE12FFF1C, 0x038011BF};
const u32 swiHaltSignature3Alt3[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803597};
const u32 swiHaltSignature3Alt4[3]  = {0xE59FC000, 0xE12FFF1C, 0x038040C3};
const u32 swiHaltSignature3Alt5[3]  = {0xE59FC000, 0xE12FFF1C, 0x038042AB};
const u32 swiHaltSignature3Alt6[3]  = {0xE59FC000, 0xE12FFF1C, 0x038042AF};
const u32 swiHaltSignature3Alt7[3]  = {0xE59FC000, 0xE12FFF1C, 0x0380433F};
const u32 swiHaltSignature3Alt8[3]  = {0xE59FC000, 0xE12FFF1C, 0x038043E3};
const u32 swiHaltSignature3Alt9[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804503};
const u32 swiHaltSignature3Alt10[3] = {0xE59FC000, 0xE12FFF1C, 0x038045BF};
const u32 swiHaltSignature3Alt11[3] = {0xE59FC000, 0xE12FFF1C, 0x0380538B};
const u32 swiHaltSignature4[3]      = {0xE59FC000, 0xE12FFF1C, 0x0380064B};
const u32 swiHaltSignature4Alt1[3]  = {0xE59FC000, 0xE12FFF1C, 0x038008C3};
const u32 swiHaltSignature4Alt2[3]  = {0xE59FC000, 0xE12FFF1C, 0x038008CF};
const u32 swiHaltSignature4Alt3[3]  = {0xE59FC000, 0xE12FFF1C, 0x0380356F};
const u32 swiHaltSignature4Alt4[3]  = {0xE59FC000, 0xE12FFF1C, 0x038036BF};
const u32 swiHaltSignature4Alt5[3]  = {0xE59FC000, 0xE12FFF1C, 0x038037D3};
const u32 swiHaltSignature4Alt6[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803E7F};
const u32 swiHaltSignature4Alt7[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803EBF};
const u32 swiHaltSignature4Alt8[3]  = {0xE59FC000, 0xE12FFF1C, 0x03804503};
const u32 swiHaltSignature5[3]      = {0xE59FC000, 0xE12FFF1C, 0x037FB2DB}; // SDK 5
const u32 swiHaltSignature5Alt1[3]  = {0xE59FC000, 0xE12FFF1C, 0x037FB51F}; // SDK 5
const u32 swiHaltSignature5Alt2[3]  = {0xE59FC000, 0xE12FFF1C, 0x037FB5E3}; // SDK 5
const u32 swiHaltSignature5Alt3[3]  = {0xE59FC000, 0xE12FFF1C, 0x037FB6FB}; // SDK 5
const u16 swiHaltSignatureThumb[2]  = {0xDF06, 0x4770};                     // SDK 5
//const u16 swiHaltSignatureThumb5[4] = {0x004B, 0x4718, 0xB463, 0x037F};     // SDK 5

// Sleep patch
const u32 sleepPatch[2]         = {0x0A000001, 0xE3A00601};
const u16 sleepPatchThumb[2]    = {0xD002, 0x4831};
const u16 sleepPatchThumbAlt[2] = {0xD002, 0x0440};

// Card check pull out
const u32 cardCheckPullOutSignature1[4] = {0xE92D4018, 0xE24DD004, 0xE59F204C, 0xE1D210B0}; // SDK != 3
const u32 cardCheckPullOutSignature3[4] = {0xE92D4000, 0xE24DD004, 0xE59F002C, 0xE1D000B0}; // SDK 3

// irq enable
const u32 irqEnableStartSignature1[4]    = {0xE59FC028, 0xE1DC30B0, 0xE3A01000, 0xE1CC10B0}; // SDK <= 3
const u32 irqEnableStartSignature4[4]    = {0xE92D4010, 0xE1A04000, 0xEBFFFFF6, 0xE59FC020}; // SDK >= 4
const u32 irqEnableStartSignature4Alt[4] = {0xE92D4010, 0xE1A04000, 0xEBFFFFE9, 0xE59FC020}; // SDK 5
