...
u32 j_HaltSignature1Alt2[4] = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x0000B92B};
u32 j_HaltSignature1Alt3[4] = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x0000BAEB};
u32 j_HaltSignature1Alt4[3] = {0xE59FC000, 0xE12FFF1C, 0x03803B93};
u32 j_HaltSignature1Alt5[3] = {0xE59FC000, 0xE12FFF1C, 0x03803DAF};
u32 j_HaltSignature1Alt6[3] = {0xE59FC000, 0xE12FFF1C, 0x03803DB3};
u32 j_HaltSignature1Alt7[3] = {0xE59FC000, 0xE12FFF1C, 0x03804133};
u32 j_HaltSignature3[3] = {0xE59FC000, 0xE12FFF1C, 0x038011BF};
u32 j_HaltSignature3Alt1[3] = {0xE59FC000, 0xE12FFF1C, 0x03800F7F};
u32 j_HaltSignature3Alt2[3] = {0xE59FC000, 0xE12FFF1C, 0x03803597};
u32 j_HaltSignature3Alt3[3] = {0xE59FC000, 0xE12FFF1C, 0x038040C3};
u32 j_HaltSignature3Alt4[3] = {0xE59FC000, 0xE12FFF1C, 0x038042AF};
u32 j_HaltSignature3Alt5[3] = {0xE59FC000, 0xE12FFF1C, 0x0380433F};
u32 j_HaltSignature3Alt6[3] = {0xE59FC000, 0xE12FFF1C, 0x038043E3};
u32 j_HaltSignature3Alt7[3] = {0xE59FC000, 0xE12FFF1C, 0x038045BF};
u32 j_HaltSignature4[3] = {0xE59FC000, 0xE12FFF1C, 0x038036BF};
u32 j_HaltSignature4Alt1[3] = {0xE59FC000, 0xE12FFF1C, 0x038037D3};
u32 j_HaltSignature4Alt2[3] = {0xE59FC000, 0xE12FFF1C, 0x03804503};
...
u32 j_GetPitchTableSignature1Alt7[3] = {0xE59FC000, 0xE12FFF1C, 0x03804189};
u32 j_GetPitchTableSignature3[3] = {0xE59FC000, 0xE12FFF1C, 0x03801215};
u32 j_GetPitchTableSignature3Alt1[3] = {0xE59FC000, 0xE12FFF1C, 0x03800FD5};
u32 j_GetPitchTableSignature3Alt2[3] = {0xE59FC000, 0xE12FFF1C, 0x03804119};
u32 j_GetPitchTableSignature3Alt3[3] = {0xE59FC000, 0xE12FFF1C, 0x03804305};
u32 j_GetPitchTableSignature3Alt4[3] = {0xE59FC000, 0xE12FFF1C, 0x03804395};
u32 j_GetPitchTableSignature3Alt5[3] = {0xE59FC000, 0xE12FFF1C, 0x03804439};
u32 j_GetPitchTableSignature3Alt6[3] = {0xE59FC000, 0xE12FFF1C, 0x03804559};
u32 j_GetPitchTableSignature3Alt7[3] = {0xE59FC000, 0xE12FFF1C, 0x03804615};
u32 j_GetPitchTableSignature4[3] = {0xE59FC000, 0xE12FFF1C, 0x038035ED};
u32 j_GetPitchTableSignature4Alt1[3] = {0xE59FC000, 0xE12FFF1C, 0x03803715};
u32 j_GetPitchTableSignature4Alt2[3] = {0xE59FC000, 0xE12FFF1C, 0x03803829};
...
u32 savePatchV4 (const tNDSHeader* ndsHeader, u32* cardEngineLocation, module_params_t* moduleParams, u32 saveFileCluster) {
	...
	u32* eepromProtect = (u32*) (JumpTableFunc + 0xF8);
	u32* cardRead = (u32*) (JumpTableFunc + 0x128);
	if((((*eepromProtect) & 0xFF000000) == 0xEB000000) 
		&& (((*cardRead) & 0xFF000000) == 0xEB000000)) {
		dbg_printf("Eeprom protect:\t");
		dbg_hexa((u32)eepromProtect);
		dbg_printf("\n");
		srcAddr = JumpTableFunc + 0xF8 - vAddrOfRelocSrc + relocDestAtSharedMem ;
		...
		*cardRead=patchCardRead;*/
		...
		u32* eepromRead = (u32*) (JumpTableFunc + 0x128);
		...
		*eepromPageWrite=patchWrite;
		...
		u32* eepromPageProg = (u32*) (JumpTableFunc + 0x13C);
		...
		*eepromPageProg=patchProg;
		...
		u32* eepromPageVerify = (u32*) (JumpTableFunc + 0x164);
		dbg_printf("Eeprom verify:\t");
		dbg_hexa((u32)eepromPageVerify);
		dbg_printf("\n");
		srcAddr =  JumpTableFunc + 0x164 - vAddrOfRelocSrc + relocDestAtSharedMem ;
		u32 patchVerify = generateA7Instr(srcAddr,
			arm7Function[2]);
		*eepromPageVerify=patchVerify;


		u32* eepromPageErase = (u32*) (JumpTableFunc + 0x174);
		dbg_printf("Eeprom page erase:\t");
		dbg_hexa((u32)eepromPageErase);
		dbg_printf("\n");
		srcAddr = JumpTableFunc + 0x174 - vAddrOfRelocSrc + relocDestAtSharedMem ;
...
u32 savePatchV3_2 (const tNDSHeader* ndsHeader, u32* cardEngineLocation, module_params_t* moduleParams, u32 saveFileCluster) {
	...
	u32* cardRead = (u32*) (JumpTableFunc + 0xE0);
	if((((*eepromProtect) & 0xFF000000) == 0xEB000000) 
		&& (((*cardRead) & 0xFF000000) == 0xEB000000)) {
		dbg_printf("Eeprom protect:\t");
		dbg_hexa((u32)eepromProtect);
		...
		*cardRead=patchCardRead;*/
		...
		u32* eepromRead = (u32*) (JumpTableFunc + 0x114);
		dbg_printf("Eeprom read:\t");
		dbg_hexa((u32)eepromRead);
		dbg_printf("\n");
		srcAddr = JumpTableFunc + 0x114  - vAddrOfRelocSrc + relocDestAtSharedMem ;
		u32 patchRead = generateA7Instr(srcAddr,
			arm7Function[5]);
		*eepromRead=patchRead;

		u32* eepromPageWrite = (u32*) (JumpTableFunc + 0x12C);
		dbg_printf("Eeprom page write:\t");
		dbg_hexa((u32)eepromPageWrite);
		dbg_printf("\n");
		srcAddr = JumpTableFunc + 0x12C - vAddrOfRelocSrc + relocDestAtSharedMem ;
		u32 patchWrite = generateA7Instr(srcAddr,
			arm7Function[3]);
		*eepromPageWrite=patchWrite;

		u32* eepromPageProg = (u32*) (JumpTableFunc + 0x144);
		dbg_printf("Eeprom page prog:\t");
		dbg_hexa((u32)eepromPageProg);
		dbg_printf("\n");
		srcAddr = JumpTableFunc + 0x144 - vAddrOfRelocSrc + relocDestAtSharedMem ;
		u32 patchProg = generateA7Instr(srcAddr,
			arm7Function[4]);
		*eepromPageProg=patchProg;

		u32* eepromPageVerify = (u32*) (JumpTableFunc + 0x15C);
		dbg_printf("Eeprom verify:\t");
		dbg_hexa((u32)eepromPageVerify);
		dbg_printf("\n");
		srcAddr =  JumpTableFunc + 0x15C - vAddrOfRelocSrc + relocDestAtSharedMem ;
		u32 patchVerify = generateA7Instr(srcAddr,
			arm7Function[2]);
		*eepromPageVerify=patchVerify;


		u32* eepromPageErase = (u32*) (JumpTableFunc + 0x16C);
		dbg_printf("Eeprom page erase:\t");
		dbg_hexa((u32)eepromPageErase);
		dbg_printf("\n");
...
u32 savePatchV3_1 (const tNDSHeader* ndsHeader, u32* cardEngineLocation, module_params_t* moduleParams, u32 saveFileCluster) {
	...
	u32* eepromProtect = (u32*) (JumpTableFunc + 0xF8);
	u32* cardRead = (u32*) (JumpTableFunc + 0xF8);
	if((((*eepromProtect) & 0xFF000000) == 0xEB000000) 
		&& (((*cardRead) & 0xFF000000) == 0xEB000000)) {
		dbg_printf("Eeprom protect:\t");
		dbg_hexa((u32)eepromProtect);
		...
		*cardRead=patchCardRead;*/
		...
		u32* eepromRead = (u32*) (JumpTableFunc + 0x12C);
		dbg_printf("Eeprom read:\t");
		dbg_hexa((u32)eepromRead);
		dbg_printf("\n");
		srcAddr = JumpTableFunc + 0x12C  - vAddrOfRelocSrc + relocDestAtSharedMem ;
		...
		*eepromRead=patchRead;
		...
		u32* eepromPageWrite = (u32*) (JumpTableFunc + 0x148);
		dbg_printf("Eeprom page write:\t");
		dbg_hexa((u32)eepromPageWrite);
		dbg_printf("\n");
		srcAddr = JumpTableFunc + 0x148 - vAddrOfRelocSrc + relocDestAtSharedMem ;
		...
		*eepromPageWrite=patchWrite;
		...
		u32* eepromPageProg = (u32*) (JumpTableFunc + 0x164);
		dbg_printf("Eeprom page prog:\t");
		dbg_hexa((u32)eepromPageProg);
		dbg_printf("\n");
		srcAddr = JumpTableFunc + 0x164 - vAddrOfRelocSrc + relocDestAtSharedMem ;
		...
		*eepromPageProg=patchProg;
		...
		u32* eepromPageVerify = (u32*) (JumpTableFunc + 0x180);
		dbg_printf("Eeprom verify:\t");
		dbg_hexa((u32)eepromPageVerify);
		dbg_printf("\n");
		...
		*eepromPageVerify=patchVerify;
		...
		u32* eepromPageErase = (u32*) (JumpTableFunc + 0x194);
		dbg_printf("Eeprom page erase:\t");
		dbg_hexa((u32)eepromPageErase);
		dbg_printf("\n");
		srcAddr = JumpTableFunc + 0x194 - vAddrOfRelocSrc + relocDestAtSharedMem ;
		u32 patchErase = generateA7Instr(srcAddr,
			arm7Function[1]);
		*eepromPageErase=patchErase; 
