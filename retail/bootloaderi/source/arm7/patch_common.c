...
void dsiWarePatch(cardengineArm9* ce9, const tNDSHeader* ndsHeader) {
	...
	if (strncmp(romTid, "KJU", 3) == 0) {
		if (isUsaOrEur) {
			...
			/* if (dsiWareAsSlot1) { // Part of .pck file
	...
	// 18th Gate (USA)
	/* else if (strcmp(romTid, "KXOE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KXOV") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K3YE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K3YV") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K3YJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K3BJ") == 0 && dsiWareAsSlot1) {
	...
	// `dataPub:/user.bin` is read when exists, but only `dataPub:/common.bin` is created and written, leaving `dataPub:/user.bin` unused (pretty sure)
	/* else if ((strcmp(romTid, "KHGJ") == 0 || strcmp(romTid, "K24J") == 0) && dsiWareAsSlot1) {
	...
	// 3450 Algo (Japan)
	/* else if (strcmp(romTid, "K5RJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K45E") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K45P") == 0 && dsiWareAsSlot1) {
	...
	// 505 Tangram (USA)
	/* else if (strcmp(romTid, "K2OE") == 0 && dsiWareAsSlot1) {
	...
	// 505 Tangram (Europe)
	/* else if (strcmp(romTid, "K2OP") == 0 && dsiWareAsSlot1) {
	...
	// 505 Tangram (Japan)
	/* else if (strcmp(romTid, "K2OJ") == 0 && dsiWareAsSlot1) {
	...
	// 90's Pool (USA)
	/* else if (strcmp(romTid, "KXPE") == 0 && dsiWareAsSlot1) {
	...
	// 90's Pool (Europe)
	/* else if (strcmp(romTid, "KXPP") == 0 && dsiWareAsSlot1) {
	...
	// 99Bullets (USA)
	/* else if (strcmp(romTid, "K99E") == 0 && dsiWareAsSlot1) {
	...
	// 99Bullets (Europe)
	/* else if (strcmp(romTid, "K99P") == 0 && dsiWareAsSlot1) {
	...
	// 99Bullets (Japan)
	/* else if (strcmp(romTid, "K99J") == 0 && dsiWareAsSlot1) {
	...
	// 99Moves (USA)
	// 99Moves (Europe)
	/* else if ((strcmp(romTid, "K9WE") == 0 || strcmp(romTid, "K9WP") == 0) && dsiWareAsSlot1) {
	...
	// 99Seconds (USA)
	// 99Seconds (Europe)
	/* else if ((strcmp(romTid, "KXTE") == 0 || strcmp(romTid, "KXTP") == 0) && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KE9E") == 0 && dsiWareAsSlot1) {
	...
	// Abyss (USA)
	// Abyss (Europe)
	/* else if ((strcmp(romTid, "KXGE") == 0 || strcmp(romTid, "KXGP") == 0) && dsiWareAsSlot1) {
	...
	else if (strncmp(romTid, "KAC", 3) == 0 && dsiWareAsSlot1) {
	...
	/* else if ((strcmp(romTid, "K25E") == 0 || strcmp(romTid, "K25J") == 0) && dsiWareAsSlot1) {
	...
	/* else if ((strcmp(romTid, "KATE") == 0 || strcmp(romTid, "KATV") == 0) && dsiWareAsSlot1) {
	...
	// Saving not supported due to unknown bug
	/* else if ((strcmp(romTid, "K27E") == 0 || strcmp(romTid, "K27J") == 0) && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KF2J") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KPCE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KPCV") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KPCJ") == 0 && dsiWareAsSlot1) {
	...
	// Antipole (USA)
	else if (strcmp(romTid, "KJHE") == 0 && dsiWareAsSlot1) {
	...
	// Antipole (Europe)
	else if (strcmp(romTid, "KJHP") == 0 && dsiWareAsSlot1) {
		const u32 newCodeAddr = 0x02F00000;
		const u32 newCodeAddr2 = newCodeAddr+0x14;
	...
	// Art Style: AQUIA (USA)
	/* else if (strcmp(romTid, "KAAE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KAAV") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KAAJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strncmp(romTid, "KAY", 3) == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KYAJ") == 0 && dsiWareAsSlot1) {
	...
	// Astro (USA)
	/* else if (strcmp(romTid, "K7DE") == 0 && dsiWareAsSlot1) {
	...
	// ATV Fever (USA)
	/* else if (strcmp(romTid, "KVUE") == 0 && dsiWareAsSlot1) {
	...
	// ATV Quad Kings (USA)
	/* else if (strcmp(romTid, "K9UE") == 0 && dsiWareAsSlot1) {
	...
	// else if (strcmp(romTid, "KSRE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KSRV") == 0 && dsiWareAsSlot1) {
		*(u32*)0x020265A8 = 0xE12FFF1E; // bx lr // Part of .pck file
	} */

	// Sukai Janpa Soru (Japan)
	/* else if (strcmp(romTid, "KSRJ") == 0 && dsiWareAsSlot1) {
	...
	// Bejeweled Twist (USA)
	/* else if (strcmp(romTid, "KBEE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KBEV") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KBEJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K96J") == 0 && dsiWareAsSlot1) {
	...
	// Bloons (USA)
	// Saving not supported due to using more than one file in filesystem
	else if (strcmp(romTid, "KBLE") == 0 && dsiWareAsSlot1) {
	...
	// Bloons (Europe)
	// Saving not supported due to using more than one file in filesystem
	else if (strcmp(romTid, "KBLP") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KLNE") == 0 || strcmp(romTid, "KLNP") == 0) && dsiWareAsSlot1) {
	...
	// Bloons TD 4 (USA)
	/* else if (strcmp(romTid, "KUVE") == 0 && dsiWareAsSlot1) {
	...
	// Bloons TD 4 (Europe)
	/* else if (strcmp(romTid, "KUVP") == 0 && dsiWareAsSlot1) {
	...
	// Bomberman Blitz (USA)
	/* else if (strcmp(romTid, "KBBE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KBBV") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02009670, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	/* else if (strcmp(romTid, "KBBJ") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02009670, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	// Bookstore Dream (USA)
	/* else if (strcmp(romTid, "KQVE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KQVV") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KQVJ") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02010A80, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	/*else if (strcmp(romTid, "KBKE") == 0 && dsiWareAsSlot1) {
	...
	// Bounce & Break (USA)
	/* else if (strcmp(romTid, "KZEE") == 0 && dsiWareAsSlot1) {
	...
	// Bounce & Break (Europe)
	/* else if (strcmp(romTid, "KZEP") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KAHE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KAHV") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KAHJ") == 0 && dsiWareAsSlot1) {
	...
	// Brain Challenge (USA)
	/* else if (strcmp(romTid, "KBCE") == 0 && dsiWareAsSlot1) {
		*(u32*)0x0200EBD8 = 0xE12FFF1E; // bx lr // Part of .pck file
	} */

	// Brain Challenge (Europe, Australia)
	/* else if (strcmp(romTid, "KBCV") == 0 && dsiWareAsSlot1) {
		*(u32*)0x0200EBF4 = 0xE12FFF1E; // bx lr // Part of .pck file
	} */

	// Bugs'N'Balls (USA)
	// Bugs'N'Balls (Europe)
	/* else if (strncmp(romTid, "KKQ", 3) == 0 && dsiWareAsSlot1) {
	...
	// Cake Ninja (USA)
	else if (strcmp(romTid, "K2JE") == 0 && !twlFontFound) {
	...
	// Cake Ninja (Europe)
	else if (strcmp(romTid, "K2JP") == 0 && !twlFontFound) {
	...
	// Cake Ninja 2 (USA)
	else if (strcmp(romTid, "K2NE") == 0 && !twlFontFound) {
	...
	// Cake Ninja 2 (Europe)
	else if (strcmp(romTid, "K2NP") == 0 && !twlFontFound) {
	...
	// Cake Ninja: XMAS (USA)
	else if (strcmp(romTid, "KYNE") == 0 && !twlFontFound) {
	...
	else if (strcmp(romTid, "KYNP") == 0 && !twlFontFound) {
	...
	/* else if (strcmp(romTid, "KCNE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KCNP") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KQOE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KQOV") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KC5E") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KC5V") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KC5J") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x0201831C, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	/* else if (strcmp(romTid, "KXCE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KXCV") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02013CF4, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	/* else if (strcmp(romTid, "KXCJ") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02013CF4, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	/* else if ((strcmp(romTid, "KQNE") == 0 || strcmp(romTid, "KQNV") == 0) && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KQNJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KBGJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KXWE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KXWP") == 0 && dsiWareAsSlot1) {
	...
	/* else if ((strcmp(romTid, "K2WE") == 0 || strcmp(romTid, "K2WP") == 0) && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K9TE") == 0 && dsiWareAsSlot1) {
	...
	// Due to the B4DS DSiWare save implementation, save data is stored in all 3 slots
	/* else if (strcmp(romTid, "K9TP") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KQLJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if ((strcmp(romTid, "KC7E") == 0 || strcmp(romTid, "KC7P") == 0) && dsiWareAsSlot1) {
	...
	/* else if ((strcmp(romTid, "KH5J") == 0 || strcmp(romTid, "KD7J") == 0) && dsiWareAsSlot1) {
	...
	// Cosmos X2 (USA)
	else if (strcmp(romTid, "KX2E") == 0 && dsiWareAsSlot1) {
	...
	// Cosmos X2 (Europe)
	else if (strcmp(romTid, "KX2P") == 0 && dsiWareAsSlot1) {
		const u32 newCodeAddr = 0x02F00000;
		const u32 newCodeAddr2 = newCodeAddr+0x14;
	...
	/* else if (strcmp(romTid, "KQZP") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KCVP") == 0 && dsiWareAsSlot1) {
	...
	// Crazy Golf (USA)
	// Saving not supported due to using more than one file in filesystem
	/* else if (strcmp(romTid, "KZGE") == 0 && dsiWareAsSlot1) {
	...
	// Saving not supported due to using more than one file in filesystem
	/* else if (strcmp(romTid, "KZGV") == 0 && dsiWareAsSlot1) {
	...
	// Crazy Pinball (USA)
	// Saving not supported due to using more than one file in filesystem
	/* else if (strcmp(romTid, "KCIE") == 0 && dsiWareAsSlot1) {
	...
	// Saving not supported due to using more than one file in filesystem
	/* else if (strcmp(romTid, "KCIV") == 0 && dsiWareAsSlot1) {
	...
	// Crazy Sudoku (USA)
	// Saving not supported due to using more than one file in filesystem
	/* else if (strcmp(romTid, "KCRE") == 0 && dsiWareAsSlot1) {
	...
	// Saving not supported due to using more than one file in filesystem
	/* else if (strcmp(romTid, "KCRV") == 0 && dsiWareAsSlot1) {
	...
	/* else if ((strcmp(romTid, "KXDE") == 0 || strcmp(romTid, "KXDP") == 0) && dsiWareAsSlot1) {
	...
	else if (strncmp(romTid, "KKT", 3) == 0 && dsiWramBlocked) {
		*(u32*)0x0203BA44 = 0xE3A0162F; // mov r1, #0x02F00000
	}

	// CuteWitch! runner (USA)
	// CuteWitch! runner (Europe)
	/* else if (strncmp(romTid, "K32", 3) == 0 && dsiWareAsSlot1) {
		u32* saveFuncOffsets[22] = {NULL};
	...
	else if ((strcmp(romTid, "KTAE") == 0 || strcmp(romTid, "KTAP") == 0 || strcmp(romTid, "KTAK") == 0) && dsiWareAsSlot1) {
		s8 offsetChange = 0;
		if (romTid[3] == 'P') {
			offsetChange = -0x10;
		} else if (romTid[3] == 'K') {
	...
	else if (strcmp(romTid, "KTAJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KF3E") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KF3J") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KSDE") == 0 || strcmp(romTid, "KSDP") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KSDJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if ((strcmp(romTid, "KDVE") == 0 || strcmp(romTid, "KDVV") == 0) && dsiWareAsSlot1) {
	...
	// Decathlon 2012 (USA)
	/* else if (strcmp(romTid, "KUIE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KUIP") == 0 && dsiWareAsSlot1) {
	...
	else if (strncmp(romTid, "K35", 3) == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KCPJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strncmp(romTid, "KN2", 3) == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KMLE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KMLJ") == 0 && dsiWareAsSlot1) {
	...
	// Dragon's Lair (Europe, Australia)
	/* else if (strcmp(romTid, "KDLV") == 0 && dsiWareAsSlot1) {
	...
	// Dreamwalker (USA)
	/* else if (strcmp(romTid, "K9EE") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "K2CE") == 0 || strcmp(romTid, "K2CK") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K2CJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KUGJ") == 0 && dsiWareAsSlot1) {
	...
	// Saving not supported due to unknown bug
	/* else if (strcmp(romTid, "KDAE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KDAJ") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "K2EE") == 0 || strcmp(romTid, "K2EP") == 0) && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K42E") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K42P") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KERJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KYBE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KYBV") == 0 && dsiWareAsSlot1) {
		*(u32*)0x0200BB44 = 0xE12FFF1E; // bx lr
		// *(u32*)0x0203C9E4 = 0xE12FFF1E; // bx lr
	}

	// Farm Frenzy (USA)
	else if (strcmp(romTid, "KFKE") == 0 && dsiWareAsSlot1) {
	...
	else if (strncmp(romTid, "KU7", 3) == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KFRE") == 0 && dsiWareAsSlot1) {
		*(u32*)0x0205FDA8 = 0xE12FFF1E; // bx lr
	}

	// Ferrari GT: Evolution (Europe, Australia)
	else if (strcmp(romTid, "KFRV") == 0 && dsiWareAsSlot1) {
	...
	// Fizz (USA)
	/* else if (strcmp(romTid, "KZZE") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KKRE") == 0 || strcmp(romTid, "KKRP") == 0) && dsiWareAsSlot1) {
	...
	// Flips: Terror in Cubicle Four (Europe, Australia)
			...
			|| strcmp(romTid, "KF9E") == 0 || strcmp(romTid, "KF9V") == 0) && dsiWareAsSlot1) {
	...
	// Flips: The Magic Faraway Tree (Europe, Australia)
			...
			|| strcmp(romTid, "KFTE") == 0 || strcmp(romTid, "KFTV") == 0) && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KFHE") == 0 || strcmp(romTid, "KFHV") == 0) && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K6JJ") == 0 && dsiWareAsSlot1) {
	...
	// Gaia's Moon (USA)
	// Gaia's Moon (Europe)
	else if ((strcmp(romTid, "KKGE") == 0 || strcmp(romTid, "KKGP") == 0) && dsiWareAsSlot1) {
	...
	// Gaia's Moon (Japan)
	else if (strcmp(romTid, "KKGJ") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KGBO") == 0 || strcmp(romTid, "KGHO") == 0 || strcmp(romTid, "KGJO") == 0 || strcmp(romTid, "KGMO") == 0 || strcmp(romTid, "KGVO") == 0) && dsiWareAsSlot1) {
	...
	// Helmet, Manhole & Vermin: Softlocks after 3 misses or exiting gameplay
	// Judge: Softlocks after limit is reached or exiting gameplay
	else if ((strcmp(romTid, "KGBJ") == 0 || strcmp(romTid, "KGHJ") == 0 || strcmp(romTid, "KGJJ") == 0 || strcmp(romTid, "KGMJ") == 0 || strcmp(romTid, "KGVJ") == 0) && dsiWareAsSlot1) {
		if (strncmp(romTid, "KGB", 3) == 0) {
	...
	// Go Fetch! (USA)
	else if (strcmp(romTid, "KGXE") == 0 && dsiWareAsSlot1) {
	...
	// Go Fetch! (Japan)
	else if (strcmp(romTid, "KGXJ") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02011824, dsiSaveGetResultCode, 0xC);
	...
	// Go Fetch! 2 (USA)
	else if (strcmp(romTid, "KKFE") == 0 && dsiWareAsSlot1) {
	...
	// Go Fetch! 2 (Japan)
	else if (strcmp(romTid, "KKFJ") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02019338, dsiSaveGetResultCode, 0xC);
	...
	else if (strcmp(romTid, "K9AE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K9AP") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KZHE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KZHP") == 0 && dsiWareAsSlot1) {
	...
	// Handy Hockey (Japan)
	else if (strcmp(romTid, "KHOJ") == 0 && dsiWareAsSlot1) {
	...
	// else if (strcmp(romTid, "K6SE") == 0 && dsiWareAsSlot1) {
		...
		*(u32*)0x0205B608 = 0xE12FFF1E; // bx lr */
		...
		/* setBL(0x0204BF68, (u32)dsiSaveOpenR); // Part of .pck file
	...
	else if (strncmp(romTid, "KKI", 3) == 0 && dsiWareAsSlot1) {
	...
	// Hidden Photo (USA)
	if (strcmp(romTid, "KHJE") == 0 && dsiWramBlocked) {
	...
	// Hidden Photo (Europe)
	if (strcmp(romTid, "DD3P") == 0 && dsiWramBlocked) {
	...
	if (strcmp(romTid, "DD3D") == 0 && dsiWramBlocked) {
	...
	else if ((strcmp(romTid, "KTXE") == 0 || strcmp(romTid, "KTXV") == 0) && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KT2E") == 0 || strcmp(romTid, "KT2P") == 0) && dsiWareAsSlot1) {
		s8 offsetChange = (romTid[3] == 'E') ? 0 : -0x10;
	...
	else if (strcmp(romTid, "KT2J") == 0 && dsiWareAsSlot1) {
	...
	else if (strncmp(romTid, "KIB", 3) == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KIKX") == 0 || strcmp(romTid, "KIKV") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KIKJ") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02013058, dsiSaveGetResultCode, 0xC);
	...
	/* // Jazzy Billiards (USA)
	// Saving seems difficult to get working
	else if (strcmp(romTid, "K9BE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KYJE") == 0 && dsiWareAsSlot1) {
		setBL(0x0203F3A4, (u32)dsiSaveOpen); // Part of .pck file
	...
	else if ((strcmp(romTid, "KJBE") == 0 || strcmp(romTid, "KJBP") == 0) && dsiWareAsSlot1) {
	...
	/* else if ((strcmp(romTid, "K43E") == 0 || strcmp(romTid, "K43P") == 0) && dsiWareAsSlot1) {
	...
	// Jump Trials (USA)
		...
		/* if (dsiWareAsSlot1) { // Part of .pck files
	...
	else if ((strcmp(romTid, "KJFE") == 0 || strcmp(romTid, "KJFP") == 0) && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "K4CE") == 0 || strcmp(romTid, "K4CP") == 0) && dsiWareAsSlot1) {
	...
	// A Kappa's Trail (USA)
	else if (strcmp(romTid, "KPAE") == 0 && dsiWareAsSlot1) {
	...
	// Kappa Michi (Japan)
	else if (strcmp(romTid, "KPAJ") == 0 && dsiWareAsSlot1) {
	...
	// Katamukusho (Japan)
	else if (strcmp(romTid, "K69J") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K3DJ") == 0 && dsiWareAsSlot1) {
	...
	// Kemonomix (Japan)
	else if (strcmp(romTid, "KMXJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K9CJ") == 0 && dsiWareAsSlot1) {
		setBL(0x0200F820, (u32)dsiSaveOpen); // Part of .pck file
	...
	else if (strcmp(romTid, "KONJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KVFJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strncmp(romTid, "KQ9", 3) == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x0200F860, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	/* else if (strcmp(romTid, "KLDE") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x0201C24C, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	/* else if (strcmp(romTid, "KLDV") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x0201C24C, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	/* else if (strcmp(romTid, "KLDJ") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x0201C1A0, dsiSaveGetResultCode, 0xC); // Part of .pck file
	...
	else if (strcmp(romTid, "K5CE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KZBE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KZBP") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KMUE") == 0 && dsiWareAsSlot1) {
	...
	// Does not save due to unknown cause
	else if (strcmp(romTid, "KM6V") == 0 && dsiWareAsSlot1) {
		*(u32*)0x02029F34 = 0xE3A00001; // mov r0, #1
	...
	else if (strcmp(romTid, "K73E") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K85J") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KXBE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KXBP") == 0 && dsiWareAsSlot1) {
	...
	// Mr. Brain (Japan)
	else if (strcmp(romTid, "KMBJ") == 0 && dsiWareAsSlot1) {
	...
	// My Farm (USA)
	else if (strcmp(romTid, "KMRE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KMRV") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KL3E") == 0 || strcmp(romTid, "KL4E") == 0) && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KL3P") == 0 || strcmp(romTid, "KL4P") == 0) && dsiWareAsSlot1) {
		tonccpy((u32*)0x0201270C, dsiSaveGetResultCode, 0xC);
	...
	// My Exotic Farm (USA)
	else if (strcmp(romTid, "KMVE") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x020126DC, dsiSaveGetResultCode, 0xC);
	...
	else if (strcmp(romTid, "KMVV") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x020126DC, dsiSaveGetResultCode, 0xC);
	...
	else if ((strcmp(romTid, "KLTE") == 0 || strcmp(romTid, "KLTV") == 0) && dsiWareAsSlot1) {
	...
	// myNotebook Red (USA)
	// myNotebook Red (Europe, Australia)
	// myNotebook Green (USA)
	// myNotebook Green (Europe, Australia)
	// myNotebook Blue (USA)
	// myNotebook Blue (Europe, Australia)
	else if ((strncmp(romTid, "KNL", 3) == 0 || strncmp(romTid, "KNG", 3) == 0 || strncmp(romTid, "KNB", 3) == 0) && dsiWramBlocked) {
		u32* patchOffset = (u32*)0x0203FF10;
		u32* patchOffset2 = (u32*)0x0203FFD0;

		if (romTid[2] == 'G') {
			patchOffset = (u32*)0x0203FF64;
			patchOffset2 = (u32*)0x02040024;
		} else if (romTid[2] == 'B') {
			patchOffset = (u32*)0x0203FF24;
			patchOffset2 = (u32*)0x0203FFE4;
		}

		patchOffset[0] = 0xE3A0162F; // mov r1, #0x02F00000
		patchOffset[1] = 0xE1A00001; // mov r0, r1
		patchOffset[2] = 0xE5840010; // str r0, [r4, 0x10]
		patchOffset[3] = 0xE2810906; // add r0, r1, 0x18000
		patchOffset[4] = 0xE5840018; // str r0, [r4, 0x18]
		patchOffset[5] = 0xE2810701; // add r0, r1, 0x40000
		patchOffset[6] = 0xE584000C; // str r0, [r4, 0x0C]
		patchOffset[7] = 0xE2810916; // add r0, r1, 0x58000
		patchOffset[8] = 0xE5840014; // str r0, [r4, 0x14]
		for (int i = 9; i <= 19; i++) {
			patchOffset[i] = 0xE1A00000; // nop
		}

		patchOffset2[0] = 0xE3A0162F; // mov r1, #0x02F00000
		patchOffset2[1] = 0xE1A00001; // mov r0, r1
		patchOffset2[2] = 0xE5870010; // str r0, [r7, 0x10]
		patchOffset2[3] = 0xE2810906; // add r0, r1, 0x18000
		patchOffset2[4] = 0xE5870018; // str r0, [r7, 0x18]
		patchOffset2[5] = 0xE2810701; // add r0, r1, 0x40000
		patchOffset2[6] = 0xE587000C; // str r0, [r7, 0x0C]
		patchOffset2[7] = 0xE2810916; // add r0, r1, 0x58000
		patchOffset2[8] = 0xE5870014; // str r0, [r7, 0x14]
		for (int i = 9; i <= 19; i++) {
			patchOffset2[i] = 0xE1A00000; // nop
		}
	}
	...
	else if (strncmp(romTid, "KNP", 3) == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K9NJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTGJ") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KAQE") == 0 || strcmp(romTid, "KAQK") == 0) && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KAQJ") == 0 || strcmp(romTid, "KWLJ") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KQ2J") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "K2DJ") == 0 || strcmp(romTid, "K2DE") == 0) && dsiWramBlocked) {
	...
	else if ((strcmp(romTid, "K2DP") == 0 || strcmp(romTid, "K2DU") == 0) && dsiWramBlocked) {
	...
	// Nintendogs (China)
	else if (strcmp(romTid, "KDOC") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K9KJ") == 0 && dsiWareAsSlot1) {
	...
	// Orion's Odyssey (USA)
	// Due to the B4DS DSiWare save implementation, save data is stored in both slots
	else if (strcmp(romTid, "K6TE") == 0 && dsiWareAsSlot1) {
	...
	// Due to the B4DS DSiWare save implementation, save data is stored in all 3 slots
	else if ((strcmp(romTid, "KO4E") == 0 || strcmp(romTid, "KO4V") == 0) && dsiWareAsSlot1) {
	...
	// Due to the B4DS DSiWare save implementation, save data is stored in all 3 slots
	else if ((strcmp(romTid, "KOTE") == 0 || strcmp(romTid, "KOTP") == 0) && dsiWareAsSlot1) {
	...
	// Due to the B4DS DSiWare save implementation, save data is stored in all 3 slots
	else if ((strcmp(romTid, "KOYE") == 0 || strcmp(romTid, "KOYP") == 0) && dsiWareAsSlot1) {
	...
	// Due to the B4DS DSiWare save implementation, save data is stored in all 3 slots
	else if ((strcmp(romTid, "KO9E") == 0 || strcmp(romTid, "KO9P") == 0) && dsiWareAsSlot1) {
		u8 offsetChange = (romTid[3] == 'E') ? 0 : 0x4C;
	...
	// Othello (Japan)
	else if (strcmp(romTid, "KOLJ") == 0 && dsiWareAsSlot1) {
	...
	// Panewa! (Japan)
	/* else if (strcmp(romTid, "KPWJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KP9E") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KP9J") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KPJE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KPJJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KUSE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KUSJ") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02016B8C, dsiSaveGetResultCode, 0xC);
	...
	else if (strcmp(romTid, "KP5V") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KPQE") == 0 || strcmp(romTid, "KPQP") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KPQJ") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KAPE") == 0 || strcmp(romTid, "KAPV") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KAPJ") == 0 && dsiWareAsSlot1) {
	...
	// Pirates Assault (USA)
	else if (strcmp(romTid, "KXAE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KXAV") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KXAJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KZLE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KZLV") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KFXE") == 0 || strcmp(romTid, "KFQE") == 0) && dsiWareAsSlot1) {
	...
	else if ((strncmp(romTid, "KAK", 3) == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KPRV") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KFVE") == 0 || strcmp(romTid, "KFVJ") == 0) && dsiWareAsSlot1) {
	...
	else if (strncmp(romTid, "KXU", 3) == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KNUP") == 0 && dsiWareAsSlot1) {
	...
	// Due to the B4DS DSiWare save implementation, save data is stored in all 3 slots
	else if ((strcmp(romTid, "KLFE") == 0 || strcmp(romTid, "KLFP") == 0) && dsiWareAsSlot1) {
	...
	// Due to the B4DS DSiWare save implementation, save data is stored in all 3 slots
	else if ((strcmp(romTid, "KLRE") == 0 || strcmp(romTid, "KLRP") == 0) && dsiWareAsSlot1) {
	...
	// Due to the B4DS DSiWare save implementation, save data is stored in all 3 slots
	else if ((strcmp(romTid, "KL2E") == 0 || strcmp(romTid, "KL2P") == 0) && dsiWareAsSlot1) {
	...
	/* // Puzzle Fever (USA)
	else if (strcmp(romTid, "KKEE") == 0 && dsiWareAsSlot1) {
		// Overlay code patch (Part of .pck file)
	...
	// Puzzle Fever (Europe)
	else if (strcmp(romTid, "K5VP") == 0 && dsiWareAsSlot1) {
		// Overlay code patch (Part of .pck file)
	...
	else if (strcmp(romTid, "KPNE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KPNV") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KPNJ") == 0 && dsiWareAsSlot1) {
	...
	// Puzzle Rocks (USA)
	else if (strcmp(romTid, "KPLE") == 0 && dsiWareAsSlot1) {
	...
	// Puzzle Rocks (Europe)
	else if (strcmp(romTid, "KPLP") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "K9PE") == 0 || strcmp(romTid, "K9PP") == 0) && dsiWareAsSlot1) {
	...
	// Remote Racers (USA)
	else if (strcmp(romTid, "KQRE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KQRV") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KRLE") == 0 || strcmp(romTid, "KRLJ") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KRPJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "K8XJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K3PJ") == 0 && dsiWareAsSlot1) {
		if (!twlFontFound) {
	...
	else if (strcmp(romTid, "K5TJ") == 0 && dsiWareAsSlot1) {
	...
	// Simply Mahjong (USA)
	else if (strcmp(romTid, "K4JE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K4JP") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KM3E") == 0 || strcmp(romTid, "KM3P") == 0) && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "K4LE") == 0 || strcmp(romTid, "K4LP") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KS4P") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K3SE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K4NE") == 0 && dsiWareAsSlot1) {
	...
	// Snakenoid (Europe)
	else if (strcmp(romTid, "K4NP") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KX5E") == 0 || strcmp(romTid, "KX5P") == 0) && dsiWareAsSlot1) {
	...
	// Sokomania (USA)
	else if (strcmp(romTid, "KSOE") == 0 && dsiWareAsSlot1) {
	...
	// Sokomania (Europe)
	else if (strcmp(romTid, "KSOP") == 0 && dsiWareAsSlot1) {
		const u32 newCode = *(u32*)0x02003000;
	...
	else if (strcmp(romTid, "KSVE") == 0 && dsiWareAsSlot1) {
		const u32 newCode = *(u32*)0x02003000;
	...
	else if (strcmp(romTid, "KSVP") == 0 && dsiWareAsSlot1) {
		const u32 newCode = *(u32*)0x02003000;
		*(u32*)0x020049E0 -= 0x1000;
	...
	else if (strcmp(romTid, "KEVJ") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KYSE") == 0 || strcmp(romTid, "KYSP") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KYSJ") == 0 && dsiWareAsSlot1) {
	...
	// Spotto! (USA)
	// Saving not supported due to using more than one file in filesystem(?)
	else if (strcmp(romTid, "KSPE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KSPV") == 0 && dsiWareAsSlot1) {
		*(u32*)0x0202D6A8 = 0xE3A00001; // mov r0, #1
		*(u32*)0x0202D6AC = 0xE12FFF1E; // bx lr
	}

	// Neratte Supotto! (Japan)
	else if (strcmp(romTid, "KSPJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if ((strcmp(romTid, "KSWE") == 0 || strcmp(romTid, "KSWV") == 0) && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KOGE") == 0 || strcmp(romTid, "KOGK") == 0) && dsiWareAsSlot1) {
		u8 offsetChange = (romTid[3] == 'E') ? 0 : 0xBC;
	...
	else if (strcmp(romTid, "KOGJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KOZJ") == 0 && dsiWareAsSlot1) {
	...
	// Due to the B4DS DSiWare save implementation, save data is stored in all 4 slots
	else if ((strcmp(romTid, "K4PE") == 0 || strcmp(romTid, "K4PV") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KSYE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KSYP") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KZUE") == 0 || strcmp(romTid, "KZVE") == 0 || strcmp(romTid, "KZ7E") == 0 || strcmp(romTid, "KZ8E") == 0) && dsiWareAsSlot1) {
	...
	// Tangrams (USA)
	else if (strcmp(romTid, "KYYE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KJTJ") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KJAJ") == 0 || strcmp(romTid, "KJQJ") == 0 || strcmp(romTid, "KJLJ") == 0 || strcmp(romTid, "KJ7J") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KOSJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KOSK") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "K3OJ") == 0 && dsiWareAsSlot1) {
	...
	// Topoloco (USA)
	// Topoloco (Europe)
	/*else if (strncmp(romTid, "KT5", 3) == 0 && dsiWareAsSlot1) {
	...
	// Trollboarder (USA)
	// Trollboarder (Europe)
	else if ((strcmp(romTid, "KB7E") == 0 || strcmp(romTid, "KB7P") == 0) && dsiWareAsSlot1) {
	...
	if ((strcmp(romTid, "K72E") == 0 || strcmp(romTid, "K72V") == 0) && dsiWareAsSlot1) {
	...
	// Ubongo (USA)
	else if (strcmp(romTid, "KUBE") == 0 && dsiWareAsSlot1) {
	...
	// Ubongo (Europe)
	else if (strcmp(romTid, "KUBP") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KKMJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KVEJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "Z2AT") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "Z2AP") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "Z2AJ") == 0 && dsiWareAsSlot1) {
	...
	// Viking Invasion (USA)
	// Saving not supported due to using more than one file in filesystem
	else if (strcmp(romTid, "KVKE") == 0 && dsiWareAsSlot1) {
	...
	// Saving not supported due to using more than one file in filesystem
	else if (strcmp(romTid, "KVKV") == 0 && dsiWareAsSlot1) {
	...
	// Whack-A-Friend (USA)
	else if (strcmp(romTid, "KWQE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KWQJ") == 0 && dsiWareAsSlot1) {
		tonccpy((u32*)0x02015134, dsiSaveGetResultCode, 0xC);
		for (int i = 0; i < 8; i++) {
	...
	else if (strcmp(romTid, "KWLK") == 0 && dsiWareAsSlot1) {
	...
	// X-Returns (Japan)
	else if (strncmp(romTid, "KDX", 3) == 0 && dsiWramBlocked) {
	...
	else if (strcmp(romTid, "KYUE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KYUV") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KNZE") == 0 || strcmp(romTid, "KZNK") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KZNJ") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KZ2J") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KASE") == 0 || strcmp(romTid, "KASV") == 0) && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KASJ") == 0 && dsiWareAsSlot1) {
	...
	else if ((strcmp(romTid, "KKHE") == 0 || strcmp(romTid, "KKHJ") == 0) && dsiWareAsSlot1) {
	...
	// Zombie Blaster (USA)
	else if (strcmp(romTid, "K7KE") == 0 && dsiWareAsSlot1) {
	...
	// Zombie Skape (USA)
	// Zombie Skape (Europe)
	else if ((strcmp(romTid, "KZYE") == 0 || strcmp(romTid, "KZYP") == 0) && dsiWareAsSlot1) {
		u8 offsetChange = (romTid[3] == 'E') ? 0 : 0x4C;
	...
	else if ((strcmp(romTid, "KZTE") == 0 || strcmp(romTid, "KZTV") == 0) && dsiWareAsSlot1) {
...
void patchBinary(cardengineArm9* ce9, const tNDSHeader* ndsHeader, module_params_t* moduleParams) {
	...
	/* else if (strcmp(romTid, "KYPE") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KYPP") == 0 && dsiWareAsSlot1) {
	...
	// Box Pusher (USA)
	/* else if (strcmp(romTid, "KQBE") == 0 && dsiWareAsSlot1) {
	...
	// Box Pusher (Europe)
	/* else if (strcmp(romTid, "KQBP") == 0 && dsiWareAsSlot1) {
	...
	// Bridge (USA)
	// Bridge (Europe)
	/* else if ((strcmp(romTid, "K9FE") == 0 || strcmp(romTid, "K9FP") == 0) && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTRT") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTRP") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTRJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTRC") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTRK") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTCT") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTPP") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTPJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTPC") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTPK") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTDT") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTBP") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTBJ") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTBC") == 0 && dsiWareAsSlot1) {
	...
	/* else if (strcmp(romTid, "KTBK") == 0 && dsiWareAsSlot1) {
	...
	else if (strncmp(romTid, "KGS", 3) == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KU2J") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KHQE") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KHQP") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KSGP") == 0 && dsiWareAsSlot1) {
	...
	else if (strcmp(romTid, "KWNP") == 0 && dsiWareAsSlot1) {
