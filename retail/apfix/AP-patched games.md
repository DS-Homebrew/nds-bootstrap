...
- Pokémon: Refined Gold Coarse (v4.0.4) (Patch required from [nds-bootstrap-extras](https://github.com/DS-Homebrew/nds-bootstrap-extras)) (IPKE-4396)
...
- Pokémon: SoothingSilver Version (v1.4) (Requires the ROM to be saved with TinkeDSi with ARM9 binary recompressed, and without the better compress method) (IPGE-0293)
...
- Pokémon: Special Adventures Edition (IRAS)
