...
- Super Kaseki Horider (Japan) (Does not work) (VDEJ)
- Super Kaseki Horider (Japan) (Rev 1) (Does not work) (VDEJ)
...
- Pokémon: Black Version (USA/Europe) (Also applies to modified ROMs, but dedicated patches will be prioritized if available.) (IRBO)
...
- Pokémon: White Version (USA/Europe) (Also applies to modified ROMs, but dedicated patches will be prioritized if available.) (IRAO)
- Pokémon: Edición Blanca (Spain) (Also applies to modified ROMs, but dedicated patches will be prioritized if available.) (IRAS)
