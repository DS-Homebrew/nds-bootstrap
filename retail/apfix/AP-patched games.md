These games are AP-patched by nds-bootstrap:
...
- Chrono Trigger (USA) (Also applies to modified ROMs) (YQUE)
- Chrono Trigger (Japan) (Also applies to modified ROMs) (YQUJ)
- Chrono Trigger (Europe) (Also applies to modified ROMs) (YQUP)
...
- C.O.P.: The Recruit (USA) (BDUE) (Also applies to modified ROMs) (BDUE)
- C.O.P.: The Recruit (Europe) (BDUP) (Also applies to modified ROMs) (BDUP)
...
- Digimon Story: Lost Evolution (Japan) (Also applies to modified ROMs) (BLEJ)
...
- Dragon Ball Kai: Ultimate Butou Den (Japan) (Also applies to modified ROMs) (TDBJ)
- Dragon Quest V: Hand of the Heavenly Bride (USA) (YV5E)
...
- Gyakuten Kenji 2 (Japan) (aka "Ace Attorney Investigations: Miles Edgeworth: Prosecuter's Path") (Also applies to modified ROMs) (BXOJ)
...
- Inazuma Eleven (Italy) (Also applies to modified ROMs) (YEEI)
- Inazuma Eleven (Europe) (Also applies to modified ROMs) (YEEP)
- Inazuma Eleven (Spain) (Also applies to modified ROMs) (YEES)
- Inazuma Eleven 2: Eissturm (Germany) (Also applies to modified ROMs) (BEBD)
- Inazuma Eleven 2: Tempete de Glace (France) (Also applies to modified ROMs) (BEBF)
- Inazuma Eleven 2: Bufera di Neve (Italy) (Also applies to modified ROMs) (BEBI)
...
- Inazuma Eleven 2: Blizzard (Europe) (Also applies to modified ROMs) (BEBP)
- Inazuma Eleven 2: Ventisca Eterna (Spain) (Also applies to modified ROMs) (BEBS)
- Inazuma Eleven 2: Feuersturm (Germany) (Also applies to modified ROMs) (BEED)
- Inazuma Eleven 2: Tempete de Feu (France) (Also applies to modified ROMs) (BEEF)
- Inazuma Eleven 2: Tempesta di Fuoco (Italy) (Also applies to modified ROMs) (BEEI)
- Inazuma Eleven 2: Kyoui no Shinryakusha: Fire (Japan) (BEEJ)
- Inazuma Eleven 2: Kyoui no Shinryakusha: Fire (Japan) (Rev 1) (BEEJ)
- Inazuma Eleven 2: Firestorm (Europe) (Also applies to modified ROMs) (BEEP)
- Inazuma Eleven 2: Tormenta de Fuego (Spain) (Also applies to modified ROMs) (BEES)
...
- Jjangguneun Monmallyeo: Mallangmallang Gomuchalheuk Daebyeonsin! (Korea) (CL4K)
- Jjangguneun Monmallyeo: Won Peulleoseu Won!: Shock Seong Land Daegyeoljeon!! (Korea) (BUCK)
- Kaibou Seirigaku DS: Touch de Hirogaru! Jintai no Kouzou to Kinou (Japan) (Also applies to Rev2 and/or modified ROMs) (BA7J)
...
- The Legend of Zelda: Spirit Tracks (USA) (Also applies to modified ROMs) (BKIE)
- The Legend of Zelda: Spirit Tracks (USA) (Rev 1) (BKIE)
- Zelda no Densetsu: Daichi no Kiteki (Japan) (BKIJ)
- The Legend of Zelda: Spirit Tracks (Europe) (Also applies to modified ROMs) (BKIP)
...
- Lupin Sansei: Shijou Saidai no Zunousen (Japan) (Also applies to modified ROMs) (BL3J)
...
- Mama's Combo Pack: Volume 1 (USA) (TCYE)
- Mama's Combo Pack: Volume 2 (USA) (TCZE)
- MapleStory DS (Japan) (Also applies to modified ROMs) (YMPJ)
- MapleStory DS (Korea) (Also applies to modified ROMs) (YMPK)
...
- Mario vs. Donkey Kong: Totsugeki Mini Land (Japan) (Also applies to modified ROMs) (V2GJ)
- Mario vs. Donkey Kong: Mini-Land Mayhem (Europe) (Also applies to modified ROMs) (V2GV)
- Medarot DS: Kabuto Ver. (Japan) (Also applies to Rev1 and/or modified ROMs) (C6OJ)
- Medarot DS: Kuwagata Ver. (Japan) (Also applies to Rev1 and/or modified ROMs) (BQWJ)
- MegaMan Zero Collection (USA) (Also applies to modified ROMs) (B6ZE)
- Rockman Zero Collection (Japan) (Also applies to modified ROMs) (B6ZJ)
- MegaMan Zero Collection (Europe) (Also applies to modified ROMs) (B6ZP)
...
- Metal Max 2: Reloaded (Japan) (Also applies to modified ROMs) (TMXJ)
...
- Mugen no Frontier Exceed: Super Robot Taisen OG Saga (Japan) (Also applies to modified ROMs) (C6FJ)
- Murder in Venice (USA) (BNQE)
- Murder in Venice (Europe) (BNQP)
- MySims: SkyHeroes (USA) (BFLE)
- MySims: SkyHeroes (Europe) (BFLP)
- Nanashi no Geemu (Japan) (Aka "The Nameless Game") (Also applies to modified ROMs) (YFQJ) (Unrelated to AP)
- Nanashi no Geemu Me (Japan) (Aka "The Nameless Game: Eye") (Also applies to modified ROMs) (B74J)
...
- New Horizon: English Course 3 (Japan) (TJ7J)
- Nihon Keizai Shinbunsha Kanshuu: Shiranai Mama dewa Son wo Suru: 'Mono ya Okane no Shikumi' DS (Japan) (BETJ)
- Ni no Kuni: Shikkoku no Madoushi (Japan) (Also applies to modified ROMs) (B2KJ)
- Nine Hours, Nine Persons, Nine Doors (USA) (Also applies to modified ROMs) (BSKE)
...
- Nora to Toki no Koubou: Kiri no Mori no Majo (Japan) (Also applies to modified ROMs) (TNRJ)
...
- Phantasy Star 0 (USA) (Also applies to modified ROMs) (C24E)
- Phantasy Star 0 (Japan) (Also applies to modified ROMs) (C24J)
- Phantasy Star 0 (Europe) (Also applies to modified ROMs) (C24P)
...
- Pokémon: Goldene Edition HeartGold (Germany) (Also applies to modified ROMs) (IPKD)
- Pokémon: HeartGold Version (USA/Europe) (Also applies to modified ROMs) (IPKE)
- Pokémon: Version Or HeartGold (France) (Also applies to modified ROMs) (IPKF)
- Pokémon: Versione Oro HeartGold (Italian) (Also applies to modified ROMs) (IPKI)
- Pocket Monsters: HeartGold (Japan) (Also applies to modified ROMs) (IPKJ)
- Pocket Monsters: HeartGold (Korean) (Also applies to modified ROMs) (IPKK)
- Pokémon: Edición Oro HeartGold (Spain) (Also applies to modified ROMs) (IPKS)
- Pokémon: Silberne Edition SoulSilver (Germany) (Also applies to modified ROMs) (IPGD)
- Pokémon: SoulSilver Version (USA/Europe) (Also applies to modified ROMs) (IPGE)
- Pokémon: Version Argent SoulSilver (France) (Also applies to modified ROMs) (IPGF)
- Pokémon: Versione Argento SoulSilver (Italian) (Also applies to modified ROMs) (IPGI)
- Pocket Monsters: SoulSilver (Japan) (Also applies to modified ROMs) (IPGJ)
- Pocket Monsters: SoulSilver (Korean) (Also applies to modified ROMs) (IPGK)
- Pokémon: Edición Plata SoulSilver (Spain) (Also applies to modified ROMs) (IPGS)
- Pokémon: Schwarze Edition (Germany) (Also applies to modified ROMs) (IRBD)
- Pokémon: Version Noire (France) (Also applies to modified ROMs) (IRBF)
- Pokémon: Versione Nera (Italy) (Also applies to modified ROMs) (IRBI)
- Pocket Monsters: Black (Japan) (Also applies to modified ROMs) (IRBJ)
- Pocket Monsters: Black (Korea) (Also applies to modified ROMs) (IRBK)
- Pokémon: Black Version (USA/Europe) (Also applies to modified ROMs) (IRBO)
- Pokémon: Edición Negra (Spain) (Also applies to modified ROMs) (IRBS)
- Pokémon: Weisse Edition (Germany) (Also applies to modified ROMs) (IRAD)
- Pokémon: Version Blanche (France) (Also applies to modified ROMs) (IRAF)
- Pokémon: Versione Bianca (Italy) (Also applies to modified ROMs) (IRAI)
- Pocket Monsters: White (Japan) (Also applies to modified ROMs) (IRAJ)
- Pocket Monsters: White (Korea) (Also applies to modified ROMs) (IRAK)
- Pokémon: White Version (USA/Europe) (Also applies to modified ROMs) (IRAO)
- Pokémon: Edición Blanca (Spain) (Also applies to modified ROMs) (IRAS)
- Pokémon Blanco (Español Latino) (Patch required from [nds-bootstrap-extras](https://github.com/DS-Homebrew/nds-bootstrap-extras)) (IRAS)
...
- Pokémon: Black Version 2 (USA/Europe) (Also applies to modified ROMs) (IREO)
- Pokémon: Edición Negra 2 (Spain) (IRES)
- Pokémon: Weisse Edition 2 (Germany) (IRDD)
- Pokémon: Version Blanche 2 (France) (IRDF)
- Pokémon: Versione Bianca 2 (Italy) (IRDI)
- Pocket Monsters: White 2 (Japan) (Also applies to modified ROMs) (IRDJ)
- Pocket Monsters: White 2 (Korea) (IRDK)
- Pokémon: White Version 2 (USA/Europe) (Also applies to modified ROMs) (IRDO)
...
- Layton Kyouju to Majin no Fue (Japan) (Also applies to Rev1 and/or modified ROMs) (BLFJ)
...
- Puppy Palace (USA) (YPTE) (Unrelated to AP)
- My Puppy Shop (Europe) (YPTP) (Unrelated to AP)
- Machi no Pet-ya-san DS: 200 Piki Wan-chan Daishuugou (Japan) (YPTJ) (Unrelated to AP)
- Puyo Puyo 7 (Japan) (BYOJ)
- Puyo Puyo!! 20th Anniversary (Japan) (Also applies to modified ROMs) (TP4J)
- Quiz! Hexagon II (Japan) (BHXJ)
- Quiz Magic Academy DS: Futatsu no Jikuuseki (Japan) (BQ2J)
- Rabbids Go Home (Europe) (Also applies to modified ROMs) (VRGV)
- Rabbids Go Home: A Comedy Adventure (USA) (Also applies to modified ROMs) (VRGE)
- Radiant Historia (USA) (Also applies to modified ROMs) (BRJE)
- Radiant Historia (Japan) (Also applies to modified ROMs) (BRJJ)
...
- RPG Tkool DS (Japan) (V29J) (Also applies to modified ROMs) (V29J)
...
- Solatorobo: Red the Hunter (USA) (Also applies to modified ROMs) (VCDE)
- Solatorobo: Red the Hunter (Europe) (Also applies to modified ROMs) (VCDV)
- Solatorobo: Sore kara CODA e (Japan) (Also applies to modified ROMs) (VCDJ)
...
- Style Savvy (USA) (Also applies to modified ROMs) (AZLE)
- My Fashion: Girls Style (Korean) (Also applies to modified ROMs) (AZLK)
- Nintendo Presents: Style Boutique (Europe) (Also applies to modified ROMs) (AZLP)
- Star Wars: The Clone Wars: Jedi Alliance (USA) (CLWE)
- Star Wars: The Clone Wars: Jedi Alliance (Europe) (CLWP)
...
- TOEIC Test Super Coach@DS (Japan) (Also applies to Rev1 and/or modified ROMs) (BT5J)
...
- Tomodachi Collection (Japan) (Rev 1) (Also applies to modified ROMs) (CCUJ)
...
- Vampire Moon: The Mystery of the Hidden Sun (Europe) (B3VP)
