...
static const u32 cardSetDmaSignatureStartThumb5[2]  = {0xB570, 0x1C05};
...
u32* findCardSetDmaSd5(const tNDSHeader* ndsHeader, const module_params_t* moduleParams, bool usesThumb) {
