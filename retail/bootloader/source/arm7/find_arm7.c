...
static const u32 swiGetPitchTableSignature1Alt5[4]  = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x00004C01};
static const u32 swiGetPitchTableSignature1Alt6[4]  = {0xE59FC004, 0xE08FC00C, 0xE12FFF1C, 0x00004CA5};
static const u32 swiGetPitchTableSignature1Alt7[3]  = {0xE59FC000, 0xE12FFF1C, 0x038039D5};
static const u32 swiGetPitchTableSignature1Alt8[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803BE9};
static const u32 swiGetPitchTableSignature1Alt9[3]  = {0xE59FC000, 0xE12FFF1C, 0x03803E05};
static const u32 swiGetPitchTableSignature1Alt10[3] = {0xE59FC000, 0xE12FFF1C, 0x03803E09};
static const u32 swiGetPitchTableSignature1Alt11[3] = {0xE59FC000, 0xE12FFF1C, 0x03803F21};
static const u32 swiGetPitchTableSignature1Alt12[3] = {0xE59FC000, 0xE12FFF1C, 0x03804189};
static const u32 swiGetPitchTableSignature1Alt13[3] = {0xE59FC000, 0xE12FFF1C, 0x038049D5};
static const u32 swiGetPitchTableSignature1Alt14[3] = {0xE59FC000, 0xE12FFF1C, 0x03804BE9};
static const u32 swiGetPitchTableSignature1Alt15[3] = {0xE59FC000, 0xE12FFF1C, 0x03804E35};
static const u32 swiGetPitchTableSignature1Alt16[3] = {0xE59FC000, 0xE12FFF1C, 0x03800D89};
...
u32* findWramClearOffset(const tNDSHeader* ndsHeader) {
	...
	if (arm7newUnitCode > 0) {
		...
		if (offset) {
			...
			goto findWramClearOffset_return;
		} else {
...
u32* findSwiGetPitchTableOffset(const tNDSHeader* ndsHeader, const module_params_t* moduleParams) {
	...
	if (moduleParams->sdk_version > 0x5000000) {
		...
		if (swiGetPitchTableOffset) {
			...
			goto findSwiGetPitchTableOffset_return;
		} else {
	...
	swiGetPitchTableOffset = findOffset(
		(u32*)ndsHeader->arm7destination, newArm7binarySize > 0x10000 ? 0x10000 : newArm7binarySize,
		swiGetPitchTableSignature1Alt6, 4
	);
	if (swiGetPitchTableOffset) {
	...
	swiGetPitchTableOffset = findOffset(
		(u32*)ndsHeader->arm7destination, newArm7binarySize > 0x10000 ? 0x10000 : newArm7binarySize,
		swiGetPitchTableSignature1Alt16, 3
	);
	if (swiGetPitchTableOffset) {
		dbg_printf("swiGetPitchTable SDK <= 2 call alt 16 found\n");
		goto findSwiGetPitchTableOffset_return;
	} else {
		dbg_printf("swiGetPitchTable SDK <= 2 call alt 16 not found\n");
	}
...
findSwiGetPitchTableOffset_return:
	dbg_printf("\n");
