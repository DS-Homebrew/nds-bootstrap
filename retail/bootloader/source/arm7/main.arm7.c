...
int arm7_main(void) {
	...
	*(vu16*)0x08240000 = 1;
	...
	if (dsBrowser) {
		...
		} else if (s2FlashcardId != 0 && s2FlashcardId != 0x5A45) {
	...
	tonccpy((u8*)CARDENGINE_ARM7_LOCATION, (u8*)CARDENGINE_ARM7_LOCATION_BUFFERED, 0x10CC);
	toncset((u8*)CARDENGINE_ARM7_LOCATION_BUFFERED, 0, 0x10CC);
